...
import { ArrowRight, BookOpen, FileText, ChevronLeft, Lightbulb, PenTool, Brain } from "lucide-react";
...
const Tutorials = () => {
    ...
    const renderArticleContent = () => {
        if (selectedArticle === null) {
            return (
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {articlesList.map((article) => (
                        <div key={article.id} className="group relative bg-card rounded-lg shadow-md overflow-hidden border border-border hover:border-primary/40 transition-colors">
                            <div className="p-6">
            ...
            const article = articlesList.find(t => t.id === selectedArticle);
                    ...
                    <div className="container px-4">
                        <div className="max-w-3xl mx-auto text-center">
                            ...
                            <p className="mt-6 text-lg md:text-xl text-muted-foreground leading-relaxed">
                                Learn how to build stronger arguments with our guides and articles.
                            </p>
                        </div>
                    </div>
                </section>
                        ...
                        {selectedArticle === null && (
                            <div className="mt-16 text-center">
                                ...
                                <Button asChild size="lg">
                                    <a href="mailto:support@argumentor.com">Contact Our Support Team</a>
                                </Button>
                            </div>
                        )}
                    </div>
