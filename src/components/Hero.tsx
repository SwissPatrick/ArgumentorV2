...
export function Hero() {
    ...
    return (
        <section className="radial-gradient w-full pt-20 pb-24 md:pt-28 md:pb-32">
            <div className="container px-4">
                <div className="max-w-3xl mx-auto text-center">
                    <h1 className="font-display text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight text-primary animate-fade-in">
